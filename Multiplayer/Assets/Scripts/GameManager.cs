...
public class GameManager : MonoBehaviour
{
    ...
    public static int questionsCorrect; //how many questions they have got correct
    ...
    public void Accept() //accept the answer and move on the the next questoin
    {
        ...
        if (isCorrect)
        {
            ...
            //FinishedQuestions.Add(currentQuestion); //if correct, then move to next question
            questionsCorrect++;
            SyncScore.changeScore(SyncScore.scoreKeeper, questionsCorrect);
        }
        currentQuestion++;
